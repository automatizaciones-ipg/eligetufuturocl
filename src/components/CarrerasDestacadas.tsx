import { 
  ...
  // Datos reales simulados de las carreras con mayor empleabilidad en Chile
  const CARRERAS_TOP = [
    {
      id: 1,
      codigo_carrera: "medicina",
      carrera: "Medicina",
      institucion: "Universidad de Chile",
      tipoInst: "Universidades",
      empleabilidad: 98.5,
      arancel: "$6.850.000",
      ingreso: "$2.800.000+",
    ...
    {
      id: 2,
      codigo_carrera: "quimica-farmacia",
    ...
    {
      id: 3,
      codigo_carrera: "ing-civil-informatica",
      carrera: "Ingeniería Civil Informática",
      institucion: "U. Técnica Federico Santa María",
      tipoInst: "Universidades",
      empleabilidad: 95.2,
      arancel: "$5.100.000",
      ingreso: "$2.100.000+",
  ...
  export default function CarrerasDestacadas() {
    return (
      ...
      <section className="w-full bg-[#F4F5F9] pb-20">
              ...
              >
                ...
                <div className="mt-auto pt-6 border-t border-gray-100 flex justify-between items-center">
                  ...
                  <a 
                    ...
                    className="flex items-center gap-1.5 text-sm font-black text-[#6544FF] uppercase tracking-wider transition-all bg-[#6544FF]/5 hover:bg-[#6544FF]/10 px-4 py-2 rounded-xl hover:gap-2"
                  >
        ...
        {/* CSS CUSTOM ANIMACIONES (Reutilizadas para que funcione standalone) */}
